...
#
#     print('新的数据{}'.format(new_disk_slot_set))
#     print('数据库中的数据{},数据类型是{},长度是{}'.format(db_disk_slot_set,type(db_disk_slot_set),len(db_disk_slot_set)))
#     print('创建的{}'.format(create_slot_set))
#     print('删除的{}'.format(remove_slot_set))
#     print('更新的{}'.format(update_slot_set))
#     record_str_list = []
#
#     # # 添加
#     # for slot in create_slot_set:
#     #     print('server信息{}'.format(host_object))
#     #     print(new_disk_dict[slot])
#     #
